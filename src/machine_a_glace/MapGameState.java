...
//				System.out.println("CHANGEMENT " + secsrobotr1 +" " +r1r.etat_courant());
		...
		if (r1b != null && Terrain.casexy(r1b.getLine(), r1b.getCol()).getEntite() != null
				&& Terrain.casexy(r1b.getLine(), r1b.getCol()).getEntite().isRobot()){
...
//				System.out.println("CHANGEMENT " + secsrobot +" " +r2b.etat_courant());
		...
		if (r2r != null && Terrain.casexy(r2r.getLine(), r2r.getCol()).getEntite() != null
				&& Terrain.casexy(r2r.getLine(), r2r.getCol()).getEntite().isRobot()){
...
//				System.out.println("CHANGEMENT " + secsrobot +" " +r2r.etat_courant());
		...
		if (r2b != null && Terrain.casexy(r2b.getLine(), r2b.getCol()).getEntite() != null
				&& Terrain.casexy(r2b.getLine(), r2b.getCol()).getEntite().isRobot()){
...
//				System.out.println("CHANGEMENT " + secsrobot +" " +r2r.etat_courant());
		...
		if (r3r != null && Terrain.casexy(r3r.getLine(), r3r.getCol()).getEntite() != null
				&& Terrain.casexy(r3r.getLine(), r3r.getCol()).getEntite().isRobot()){
...
//				System.out.println("CHANGEMENT " + secsrobot +" " +r3r.etat_courant());
		...
		if (r3b != null && Terrain.casexy(r3b.getLine(), r3b.getCol()).getEntite() != null
				&& Terrain.casexy(r3b.getLine(), r3b.getCol()).getEntite().isRobot()){
...
//				System.out.println("CHANGEMENT " + secsrobot +" " +r3b.etat_courant());
		...
		if (r4r != null && Terrain.casexy(r4r.getLine(), r4r.getCol()).getEntite() != null
				&& Terrain.casexy(r4r.getLine(), r4r.getCol()).getEntite().isRobot()){
...
//				System.out.println("CHANGEMENT " + secsrobot +" " +r4r.etat_courant());
		...
		if (r4b != null && Terrain.casexy(r4b.getLine(), r4b.getCol()).getEntite() != null
				&& Terrain.casexy(r4b.getLine(), r4b.getCol()).getEntite().isRobot()){
